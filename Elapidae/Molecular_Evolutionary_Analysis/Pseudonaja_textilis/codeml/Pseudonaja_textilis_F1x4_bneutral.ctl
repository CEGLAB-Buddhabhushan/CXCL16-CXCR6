      seqfile = Pseudonaja_textilis.aln.faa * sequence data filename
     treefile = Pseudonaja_textilis.nwk      * tree structure file name
      outfile = Pseudonaja_textilis_F1x4_bneutral.out        * main result file name
