      seqfile = Toxicofera.aln.faa * sequence data filename
     treefile = Protobothrops_mucrosquamatus.nwk      * tree structure file name
      outfile = Protobothrops_mucrosquamatus_F1x4_bneutral.out        * main result file name
