      seqfile = Hydrophis_cyanocinctus.aln.faa * sequence data filename
     treefile = Hydrophis_cyanocinctus.nwk      * tree structure file name
      outfile = Hydrophis_cyanocinctus_F1x4_bneutral.out        * main result file name
