      seqfile = Alligator_mississippiensis.aln.faa * sequence data filename
     treefile = Alligator_mississippiensis.nwk      * tree structure file name
      outfile = Alligator_mississippiensis_F1x4_bneutral.out        * main result file name
