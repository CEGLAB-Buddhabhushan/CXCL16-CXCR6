      seqfile = Gavialis_gangeticus.aln.faa * sequence data filename
     treefile = Gavialis_gangeticus.nwk      * tree structure file name
      outfile = Gavialis_gangeticus_F1x4_bneutral.out        * main result file name
