      seqfile = Crocodylia.aln.faa * sequence data filename
     treefile = Chelonoidis_abingdonii.nwk      * tree structure file name
      outfile = Chelonoidis_abingdonii_F1x4_bneutral.out        * main result file name
