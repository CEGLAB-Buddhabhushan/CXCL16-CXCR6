      seqfile = Accipitriformes.aln.faa * sequence data filename
     treefile = Haliaeetus_leucocephalus.nwk      * tree structure file name
      outfile = Haliaeetus_leucocephalus_F1x4_bneutral.out        * main result file name
