      seqfile = Serinus_canaria.aln.faa * sequence data filename
     treefile = Serinus_canaria.nwk      * tree structure file name
      outfile = Serinus_canaria_F1x4_bneutral.out        * main result file name
