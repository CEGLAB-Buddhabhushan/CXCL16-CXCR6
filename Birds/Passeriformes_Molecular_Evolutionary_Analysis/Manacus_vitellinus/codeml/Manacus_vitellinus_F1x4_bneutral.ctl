      seqfile = Manacus_vitellinus.aln.faa * sequence data filename
     treefile = Manacus_vitellinus.nwk      * tree structure file name
      outfile = Manacus_vitellinus_F1x4_bneutral.out        * main result file name
