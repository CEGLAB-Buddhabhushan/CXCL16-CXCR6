      seqfile = Geospiza_fortis.aln.faa * sequence data filename
     treefile = Geospiza_fortis.nwk      * tree structure file name
      outfile = Geospiza_fortis_F1x4_bneutral.out        * main result file name
