      seqfile = Zonotrichia_albicollis.aln.faa * sequence data filename
     treefile = Zonotrichia_albicollis.nwk      * tree structure file name
      outfile = Zonotrichia_albicollis_F1x4_bneutral.out        * main result file name
