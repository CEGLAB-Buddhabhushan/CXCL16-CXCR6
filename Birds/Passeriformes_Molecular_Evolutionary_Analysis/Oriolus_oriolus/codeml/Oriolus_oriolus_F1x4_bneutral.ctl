      seqfile = Oriolus_oriolus.aln.faa * sequence data filename
     treefile = Oriolus_oriolus.nwk      * tree structure file name
      outfile = Oriolus_oriolus_F1x4_bneutral.out        * main result file name
