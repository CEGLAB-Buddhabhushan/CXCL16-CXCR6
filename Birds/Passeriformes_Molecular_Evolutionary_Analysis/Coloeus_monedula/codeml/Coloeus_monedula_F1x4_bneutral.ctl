      seqfile = Coloeus_monedula.aln.faa * sequence data filename
     treefile = Coloeus_monedula.nwk      * tree structure file name
      outfile = Coloeus_monedula_F1x4_bneutral.out        * main result file name
