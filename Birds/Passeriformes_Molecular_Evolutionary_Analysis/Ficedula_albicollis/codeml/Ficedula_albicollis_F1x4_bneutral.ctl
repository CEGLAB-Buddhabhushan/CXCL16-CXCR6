      seqfile = Ficedula_albicollis.aln.faa * sequence data filename
     treefile = Ficedula_albicollis.nwk      * tree structure file name
      outfile = Ficedula_albicollis_F1x4_bneutral.out        * main result file name
