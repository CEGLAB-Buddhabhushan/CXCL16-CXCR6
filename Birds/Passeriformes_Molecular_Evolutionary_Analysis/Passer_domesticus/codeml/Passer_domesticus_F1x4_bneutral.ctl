      seqfile = Passer_domesticus.aln.faa * sequence data filename
     treefile = Passer_domesticus.nwk      * tree structure file name
      outfile = Passer_domesticus_F1x4_bneutral.out        * main result file name
