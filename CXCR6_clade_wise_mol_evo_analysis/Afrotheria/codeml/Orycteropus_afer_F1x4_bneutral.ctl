      seqfile = Afrotheria.aln.faa * sequence data filename
     treefile = Orycteropus_afer.nwk      * tree structure file name
      outfile = Orycteropus_afer_F1x4_bneutral.out        * main result file name
