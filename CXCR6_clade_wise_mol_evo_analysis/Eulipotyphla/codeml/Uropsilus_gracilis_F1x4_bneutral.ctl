      seqfile = Eulipotyphla.aln.faa * sequence data filename
     treefile = Uropsilus_gracilis.nwk      * tree structure file name
      outfile = Uropsilus_gracilis_F1x4_bneutral.out        * main result file name
