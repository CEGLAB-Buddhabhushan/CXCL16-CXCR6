      seqfile = Carnivora.aln.faa * sequence data filename
     treefile = Leptonychotes_weddellii.nwk      * tree structure file name
      outfile = Leptonychotes_weddellii_F1x4_bneutral.out        * main result file name
