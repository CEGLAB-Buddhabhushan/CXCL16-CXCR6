      seqfile = Metatheria_Monotremata.aln.faa * sequence data filename
     treefile = Ornithorhynchus_anatinus.nwk      * tree structure file name
      outfile = Ornithorhynchus_anatinus_F1x4_bneutral.out        * main result file name
