      seqfile = Artiodactyla.aln.faa * sequence data filename
     treefile = Odocoileus_virginianus.nwk      * tree structure file name
      outfile = Odocoileus_virginianus_F1x4_bneutral.out        * main result file name
