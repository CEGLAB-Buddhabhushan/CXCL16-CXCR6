      seqfile = Birds1.aln.faa * sequence data filename
     treefile = Dromaius_novaehollandiae.nwk      * tree structure file name
      outfile = Dromaius_novaehollandiae_F1x4_bneutral.out        * main result file name
