      seqfile = Xenarthra.aln.faa * sequence data filename
     treefile = Myrmecophaga_tridactyla.nwk      * tree structure file name
      outfile = Myrmecophaga_tridactyla_F1x4_bneutral.out        * main result file name
